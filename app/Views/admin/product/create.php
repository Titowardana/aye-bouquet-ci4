                ...
                <div class="space-y-5">
                    ...
                    <div class="space-y-1.5">
                        ...
                        <textarea name="description" rows="4" placeholder="Deskripsi detail produk..."
                                  class="w-full px-4 py-2.5 rounded-xl border border-outline-variant bg-surface-container-lowest dark:bg-surface-container text-sm text-on-surface focus:border-primary focus:ring-1 focus:ring-primary shadow-sm outline-none transition-all resize-none"><?= old('description') ?></textarea>
                    </div>
                </div>
            </div>
