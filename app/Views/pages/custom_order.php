...
<div class="w-full max-w-[1280px] mx-auto px-container-padding-mobile md:px-container-padding-desktop py-12 md:py-20 flex flex-col gap-section-gap bg-warm-cream dark:bg-[#1c191a]">
    <!-- Page Header -->
    ...
    <section class="max-w-3xl mx-auto w-full">
        <form class="space-y-8" id="customOrderForm">
            ...
            <div class="bg-white-warm dark:bg-[#262024] rounded-xl soft-shadow p-6 md:p-8 space-y-8 card-hover">
                <h2 class="font-headline-md text-2xl font-bold text-on-surface dark:text-white border-b border-soft-beige/30 dark:border-white/10 pb-4">Detail Produk</h2>
                        ...
                        <?php if (!empty($categories) && is_array($categories)): ?>
                            <?php foreach ($categories as $index => $category): ?>
                                <label class="cursor-pointer">
                                    ...
                                    <div class="p-4 rounded-lg border border-soft-beige/30 dark:border-white/15 bg-white-warm dark:bg-white/5 text-center hover:bg-soft-beige/30 dark:hover:bg-white/10 transition-colors peer-checked:border-primary peer-checked:bg-primary-container/20 dark:peer-checked:bg-primary/20 peer-checked:text-primary font-body-md text-base dark:text-white flex flex-col items-center justify-center gap-2">
                                        <?php
                            ...
                            <?php endforeach; ?>
                        <?php else: ?>
                            <div class="col-span-2 md:col-span-3 p-4 text-center border border-dashed border-soft-beige/30 dark:border-white/15 rounded-lg text-on-surface-variant dark:text-white/70 text-sm">
                        ...
                        <?php if (!empty($sizeOptions)): ?>
                            <?php foreach ($sizeOptions as $idx => $size): ?>
                                <label class="cursor-pointer">
                                    ...
                                    <div class="px-6 py-2 rounded-full border border-soft-beige/30 dark:border-white/15 bg-white-warm dark:bg-white/10 text-on-surface-variant dark:text-white/70 hover:bg-soft-beige/30 dark:hover:bg-white/20 transition-colors peer-checked:bg-primary peer-checked:text-on-primary peer-checked:border-primary font-label-md text-sm font-bold"><?= esc($size['name']) ?></div>
                                </label>
                            <?php endforeach; ?>
                        <?php else: ?>
                            <p class="text-sm text-on-surface-variant italic w-full">Belum ada opsi ukuran tersedia.</p>
                            <input type="text" name="size_manual" id="size_manual" class="w-full px-4 py-3 rounded-lg border border-soft-beige/30 dark:border-white/15 bg-white-warm dark:bg-white/5 focus:border-primary focus:ring-2 focus:ring-primary-container focus:outline-none transition-all font-body-md text-base text-on-surface dark:text-white" placeholder="Masukkan ukuran (S/M/L/dll)">
                        <?php endif; ?>
                    </div>
                </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div class="space-y-2">
                        ...
                        <div class="relative">
                            ...
                            <input class="w-full pl-12 pr-4 py-3 rounded-lg border border-soft-beige/30 dark:border-white/15 bg-white-warm dark:bg-white/5 focus:border-primary focus:ring-2 focus:ring-primary-container focus:outline-none transition-all font-body-md text-base text-on-surface dark:text-white placeholder:text-on-surface-variant/50 dark:placeholder:text-white/40" id="budget" name="budget" placeholder="Contoh: 150.000" type="text">
                        </div>
                    </div>
                    ...
                    <div class="space-y-2">
                        ...
                        <div class="relative">
                            ...
                            <input class="w-full pl-12 pr-4 py-3 rounded-lg border border-soft-beige/30 dark:border-white/15 bg-white-warm dark:bg-white/5 focus:border-primary focus:ring-2 focus:ring-primary-container focus:outline-none transition-all font-body-md text-base text-on-surface dark:text-white" id="date" name="date" type="date">
                        </div>
                    </div>
                </div>
            </div>
            ...
            <!-- Customization Card -->
            <div class="bg-white-warm dark:bg-[#262024] rounded-xl soft-shadow p-6 md:p-8 space-y-8 card-hover">
                <h2 class="font-headline-md text-2xl font-bold text-on-surface dark:text-white border-b border-soft-beige/30 dark:border-white/10 pb-4">Gaya & Tema</h2>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div class="space-y-2">
                        ...
                        <input class="w-full px-4 py-3 rounded-lg border border-soft-beige/30 dark:border-white/15 bg-white-warm dark:bg-white/5 focus:border-primary focus:ring-2 focus:ring-primary-container focus:outline-none transition-all font-body-md text-base text-on-surface dark:text-white placeholder:text-on-surface-variant/50 dark:placeholder:text-white/40" id="warna" name="warna" placeholder="Contoh: Pink pastel dan Putih" type="text">
                    </div>
                    <div class="space-y-2">
                        <label class="font-label-md text-sm font-bold text-on-surface-variant dark:text-white/80 block" for="tema">Tema Acara</label>
                        <input class="w-full px-4 py-3 rounded-lg border border-soft-beige/30 dark:border-white/15 bg-white-warm dark:bg-white/5 focus:border-primary focus:ring-2 focus:ring-primary-container focus:outline-none transition-all font-body-md text-base text-on-surface dark:text-white placeholder:text-on-surface-variant/50 dark:placeholder:text-white/40" id="tema" name="tema" placeholder="Contoh: Ulang Tahun, Wisuda" type="text">
                    </div>
                </div>
                ...
                <div class="space-y-2">
                    ...
                    <input class="w-full px-4 py-3 rounded-lg border border-soft-beige/30 dark:border-white/15 bg-white-warm dark:bg-white/5 focus:border-primary focus:ring-2 focus:ring-primary-container focus:outline-none transition-all font-body-md text-base text-on-surface dark:text-white placeholder:text-on-surface-variant/50 dark:placeholder:text-white/40" id="bahan" name="bahan" placeholder="Contoh: Mawar asli, cokelat silverqueen, dll" type="text">
                </div>
                
                <!-- Extras / Add-on Tambahan -->
                <div class="space-y-4 pt-4 border-t border-soft-beige/30 dark:border-white/10 border-dashed">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <?php if (!empty($addonOptions)): ?>
                            ...
                            <label class="flex items-center gap-3 md:gap-4 p-4 md:p-5 rounded-xl border cursor-pointer transition-all duration-200 select-none
                                          bg-white-warm border-soft-beige/50 shadow-sm
                                          hover:border-primary/30 hover:shadow-md hover:-translate-y-0.5
                                          has-[:checked]:border-primary has-[:checked]:bg-warm-blush/60 has-[:checked]:shadow-primary/5
                                          dark:bg-white/5 dark:border-white/15 dark:hover:border-white/30 dark:hover:bg-white/[0.07]
                                          dark:has-[:checked]:bg-primary/15 dark:has-[:checked]:border-primary/40">
                                ...
                                <div class="flex-1 min-w-0 space-y-0.5">
                                    <p class="font-label-md text-sm font-bold text-on-surface dark:text-white leading-snug"><?= esc($addon['name']) ?></p>
                                    <p class="font-label-sm text-xs <?= $addon['additional_price'] == 0 ? 'text-primary/70 dark:text-primary-fixed-dim font-semibold' : 'text-on-surface-variant dark:text-white/60' ?>">
                                        <?= $addon['additional_price'] == 0 ? 'Gratis' : '+ Rp ' . number_format($addon['additional_price'], 0, ',', '.') ?>
                                    </p>
                                </div>
                                <div class="relative w-[46px] h-[26px] rounded-full transition-all duration-300 flex-shrink-0
                                            bg-soft-beige/70
                                            peer-checked:bg-primary
                                            after:content-[''] after:absolute after:top-[2px] after:left-[2px] after:bg-white after:rounded-full after:h-[22px] after:w-[22px] after:transition-all after:duration-300 after:shadow-md after:border after:border-gray-200/50
                                            peer-checked:after:translate-x-[20px] peer-checked:after:border-white
                                            dark:bg-white/30 dark:peer-checked:bg-primary dark:after:bg-gray-200">
                                </div>
                            </label>
                            <?php endforeach; ?>
                        <?php else: ?>
                ...
                <div class="space-y-2">
                    ...
                    <textarea class="w-full px-4 py-3 rounded-lg border border-soft-beige/30 dark:border-white/15 bg-white-warm dark:bg-white/5 focus:border-primary focus:ring-2 focus:ring-primary-container focus:outline-none transition-all font-body-md text-base text-on-surface dark:text-white placeholder:text-on-surface-variant/50 dark:placeholder:text-white/40 resize-none" id="pesan" name="pesan" placeholder="Tuliskan pesan manis untuk penerima..." rows="3"></textarea>
                </div>
            </div>

            <!-- Personal Details Card -->
            <div class="bg-white-warm dark:bg-[#262024] rounded-xl soft-shadow p-6 md:p-8 space-y-8 card-hover">
                <h2 class="font-headline-md text-2xl font-bold text-on-surface dark:text-white border-b border-soft-beige/30 dark:border-white/10 pb-4">Data Pemesan</h2>
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div class="space-y-2">
                        <label class="font-label-md text-sm font-bold text-on-surface-variant dark:text-white/80 block" for="nama">Nama Lengkap</label>
                        <input class="w-full px-4 py-3 rounded-lg border border-soft-beige/30 dark:border-white/15 bg-white-warm dark:bg-white/5 focus:border-primary focus:ring-2 focus:ring-primary-container focus:outline-none transition-all font-body-md text-base text-on-surface dark:text-white placeholder:text-on-surface-variant/50 dark:placeholder:text-white/40" id="nama" name="nama" placeholder="Nama Anda" type="text" required>
                    </div>
                    <div class="space-y-2">
                        ...
                        <input class="w-full px-4 py-3 rounded-lg border border-soft-beige/30 dark:border-white/15 bg-white-warm dark:bg-white/5 focus:border-primary focus:ring-2 focus:ring-primary-container focus:outline-none transition-all font-body-md text-base text-on-surface dark:text-white placeholder:text-on-surface-variant/50 dark:placeholder:text-white/40" id="nohp" name="nohp" placeholder="08xx xxxx xxxx" type="tel" required>
                    </div>
                </div>
                <div class="space-y-2">
                    ...
                    <textarea class="w-full px-4 py-3 rounded-lg border border-soft-beige/30 dark:border-white/15 bg-white-warm dark:bg-white/5 focus:border-primary focus:ring-2 focus:ring-primary-container focus:outline-none transition-all font-body-md text-base text-on-surface dark:text-white placeholder:text-on-surface-variant/50 dark:placeholder:text-white/40 resize-none" id="catatan" name="catatan" placeholder="Ada instruksi tambahan?" rows="2"></textarea>
                </div>
            </div>

            <!-- Note & CTA -->
            <div class="space-y-6 text-center">
                <div class="inline-flex items-center gap-2 px-4 py-3 rounded-lg bg-white-warm dark:bg-white/5 border border-soft-beige/30 dark:border-white/15 text-on-surface-variant dark:text-white/70 font-label-sm text-xs max-w-lg mx-auto text-left">
    ...
    <section class="mt-12 space-y-8 animate-on-scroll">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-6" data-stagger>
            ...
            <div class="bg-white-warm dark:bg-[#262024] rounded-xl soft-shadow overflow-hidden group card-hover">
